...
def build_parser():
    ...
    parser.add_argument('--cuda', action='store_false', help='If we want to run on gpu.') # TODO: should probably be cpu instead.
    parser.add_argument('--name', type=str, default=None, help="If we want to add a random str to the folder.")

    # Model specific options
    parser.add_argument('--layers_size', default=[250, 150, 100, 100, 50, 25, 10], type=int, nargs='+', help='Number of layers to use.')
