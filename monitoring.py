...
def load_checkpoint(load_folder, opt,input_size, additional_info, filename='checkpoint.pth.tar',impute=False, dataset = '.'):
    ...
    # Get the network
    my_model = models.get_model(new_opt, input_size, additional_info, model_state)
